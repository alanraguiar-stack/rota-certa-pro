  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        route: {
          economy: "hsl(var(--route-economy))",
          speed: "hsl(var(--route-speed))",
          balanced: "hsl(var(--route-balanced))",
          "end-near": "hsl(var(--route-end-near))",
          "start-near": "hsl(var(--route-start-near))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
